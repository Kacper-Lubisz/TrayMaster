    ...
    render(): React.ReactNode {
        return <>
            ...
            <div id="switch-box">
                ...
                {this.props.user.accessibleWarehouses.length === 3 ? <p>
                    You don't have access to any warehouses! You might want to contact your administrator.
                </p> : <div id="warehouse-list">
